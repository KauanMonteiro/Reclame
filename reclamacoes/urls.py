...
urlpatterns = [
    ...
    path('ler_denuncias/<int:reclamacao_id>/', views.ler_denuncias, name='ler_denuncias'),
    path('delete_denuncia/<int:denuncia_id>/', views.deletar_denuncia, name='delete_denuncia'),
